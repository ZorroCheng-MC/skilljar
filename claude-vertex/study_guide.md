# Claude with Google Cloud's Vertex AI — Study Guide
...
- Once you've found the model you want to use, you may need to enable it. On the model information page, click the
'Enable'
button
- If you don't see an
'Enable'
button then you already have access to the model

#### Step Three: Install the gcloud CLI

If you don't already have the gcloud CLI installed, follow the directions here to install and authenticate with the CLI:
